...
hist.show()
hist.write_image("images/Hist_residual_error_model_testing_"+now+"2020Pred.png",width=1980, height=1080)
...
pred_errors.show()
pred_errors.write_image("images/Scatter_residual_error_model_testing"+now+"2020Pred.png",width=1980, height=1080)
...
MSE_r2.show()
MSE_r2.write_image("images/Time_series_model_error_2020_predictions"+now+".png",width=500, height=300)
...
top_cnt.show()
top_cnt.write_image("images/Choro_top10_ACS_counties_pred_"+now+"2020Pred.png",width=1980, height=1080)
...
Pred2020_error.show()
Pred2020_error.write_image("images/Choro_average_pred_error_2020"+now+".png",width=1980, height=1080)
