...
def model1():
    ...
    feature_df1 = pd.read_csv("main/streamlit/data/tree_model1_features.csv")
    ...
    corr_df = pd.read_csv("main/streamlit/data/correlation_matrix.csv").drop("Unnamed: 0", axis=1)
    ...
    feature_df2 = pd.read_csv("main/streamlit/data/tree_model2_features.csv")
    ...
    data2019 = pd.read_csv("main/streamlit/data/prediction_map.csv")
