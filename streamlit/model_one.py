...
def model1():
    ...
    corr_df = pd.read_csv("streamlit/data/correlation_matrix.csv").drop("Unnamed: 0", axis=1)
    ...
    feature_df2 = pd.read_csv("streamlit/data/tree_model2_features.csv")
    ...
    data2019 = pd.read_csv("streamlit/data/prediction_map.csv")
