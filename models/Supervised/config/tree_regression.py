...
def tree_model():
    ...
    df = pd.read_pickle('../data//fulldataset.pkl')
    ...
    fig.write_image("../reports/tree_model1_feature_importances.png",width=500, height=300)
    ...
    fig.write_image("../reports/tree_model1_prediciton_delta.png", width=500, height=300)
    ...
    fig.write_image("../reports/tree_model1_scores.png", width=500, height=300)
    ...
    plt.savefig('../reports/tree_model1_correlation_matrix.png')
    ...
    fig.write_image("../reports/tree_model2_feature_importances.png", width=500, height=300)
    ...
    fig.update_layout(margin={"r":0,"t":0,"l":0,"b":0})
    fig.write_image("../reports/tree_model2_prediciton_delta.png", width=500, height=300)
    ...
    fig.write_image("../reports/tree_model2_scores.png", width=500, height=300)
